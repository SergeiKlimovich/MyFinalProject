...
<main>
    <div class="container">
        ...
        <c:if test="${order.getStatus().toString().equals(\"PRODUCED\")}">
            <h3 class="display-3" align="center">Ваш заказ готов. Самовывоз по адресу: г. Минск, ул Ангарская, 1.</h3>
        </c:if>
        <c:if test="${order.getStatus().toString().equals(\"UNDER_CONSIDERATION\")}">
            <h3 class="display-3" align="center">Ваш заказ находится в обработке.</h3>
        </c:if>
        </div>
    </div>
</main>
